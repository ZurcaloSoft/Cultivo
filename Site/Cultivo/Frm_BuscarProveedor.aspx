<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Frm_BuscarProveedor.aspx.cs" Inherits="SGF.Cultivo.Frm_BuscarProveedor" %>
...
<body>
  <form id="form1" runat="server">
       ...
       <table width="100%">
            <tr>
                <td align="center">
                    <asp:Label runat="server" ID="lbl_Titulo" Text="BUSCAR PROVEEDOR"
