...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnl_Buscar" runat="server">
        ...
        <fieldset runat="server" id="fiel_Buscar">
            ...
            <table width="100%">
                <tr>
                    <td width="150px" align="center">Empresa:
                    </td>
                    <td>
                        <telerik:RadComboBox ID="cmb_EmpresaBuscar" runat="server" Width="250px">
                        </telerik:RadComboBox>
                    </td>
                </tr>
                <tr>
    ...
    <asp:Panel ID="pnl_Buscador" runat="server">
        <fieldset>
            ...
            <telerik:RadGrid ID="gv_Sucursal" runat="server" AutoGenerateColumns="false" AllowPaging="True" OnItemCommand="gv_Sucursal_ItemCommand" OnNeedDataSource="gv_Sucursal_NeedDataSource">
                <ClientSettings AllowColumnsReorder="True" AllowDragToGroup="True" EnableRowHoverStyle="True"
                    ReorderColumnsOnClient="True">
                    <Selecting AllowRowSelect="True" />
                    <Scrolling AllowScroll="True" />
                </ClientSettings>
                <MasterTableView AllowSorting="True" CommandItemDisplay="Top" DataKeyNames="SucursalID">
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="Empresa" FilterControlAltText="Filter Empresa column"
                            HeaderText="Empresa" UniqueName="column2" ItemStyle-Width="250px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Nombre" FilterControlAltText="Filter Representante column"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Editar" Groupable="false" ItemStyle-Width="1px">
                            <ItemTemplate>
                                <asp:ImageButton ID="ibtnEditar" runat="server" CausesValidation="false" CommandName="editar"
                                    TabIndex="1" CommandArgument='<%# Eval("SucursalID") %>' ImageUrl="~/Images/edit.png"
        ...
        <fieldset>
            ...
            <table width="100%">
                <tr>
                    <td>Empresa:</td>
                    <td>
                        <telerik:RadComboBox ID="cmb_Empresa" runat="server" Width="250px"></telerik:RadComboBox>
                    </td>
                    <td></td>
                    <td></td>
                </tr>
