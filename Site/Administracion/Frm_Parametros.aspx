...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnl_Buscador" runat="server">
        ...
        <fieldset>
            ...
            <telerik:RadGrid ID="gv_Parametro" runat="server" AutoGenerateColumns="false" AllowPaging="True" OnItemCommand="gv_Parametro_ItemCommand" OnNeedDataSource="gv_Parametro_NeedDataSource">
                <ClientSettings AllowColumnsReorder="True" AllowDragToGroup="True" EnableRowHoverStyle="True"
                    ReorderColumnsOnClient="True">
                    <Selecting AllowRowSelect="True" />
                    <Scrolling AllowScroll="True" />
                </ClientSettings>
                <MasterTableView AllowSorting="True" CommandItemDisplay="Top" DataKeyNames="ParametroID">
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="PKEY" FilterControlAltText="Filter Nombre column"
                            HeaderText="Nombre" UniqueName="column1" ItemStyle-Width="200px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Tipo Parametro" FilterControlAltText="Filter Descripcion column"
                            HeaderText="Descripcion" UniqueName="column2" ItemStyle-Width="250px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Valor" FilterControlAltText="Filter Descripcion column"
                            HeaderText="Descripcion" UniqueName="column2" ItemStyle-Width="250px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Comentarios" FilterControlAltText="Filter Descripcion column"
                            HeaderText="Descripcion" UniqueName="column2" ItemStyle-Width="250px">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Editar" Groupable="false" ItemStyle-Width="1px">
                            <ItemTemplate>
                                <asp:ImageButton ID="ibtnEditar" runat="server" CausesValidation="false" CommandName="editar"
                                    TabIndex="1" CommandArgument='<%# Eval("ParametroID") %>' ImageUrl="~/Images/edit.png"
        ...
        <fieldset>
            ...
            <table width="100%">
                <tr>
                    <td>PKEY:</td>
                    <td>
                        <telerik:RadTextBox ID="txt_pkey" runat="server" Width="200px">
                        </telerik:RadTextBox>
                    </td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Tipo Parametro:</td>
                    <td>
                        <telerik:RadTextBox ID="txt_Parametro" runat="server" Width="100px"></telerik:RadTextBox></td>
                </tr>
                <tr>
                    <td>Valor:</td>
                    <td>
                        <telerik:RadTextBox ID="txt_Valor" runat="server" Width="400px" Height="40px"></telerik:RadTextBox></td>
                </tr>
                <tr>
                    <td>Comentarios:</td>
                    <td colspan="3">
                        <telerik:RadTextBox ID="txt_Comentario" runat="server" Width="400px" Height="40px"></telerik:RadTextBox></td>
                </tr>
                <tr>
                    <td>Módulo:</td>
                    <td colspan="3">
                        <telerik:RadComboBox ID="cmb_Modulo" runat="server" Width="250px">
                        </telerik:RadComboBox>
                    </td>
                </tr>
                <tr>
